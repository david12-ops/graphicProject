...
// */
// public SeedFillBorder(Raster<Col> raster, Col borderColor, Col fillColor, int
// x, int y) {
// super(null);
// this.raster = raster;
...
// * @param y Starting y-coordinate
// */
// public SeedFillBorder(Raster<Col> raster, Raster<Col> patternRaster, Col
// borderColor, int x, int y) {
// super(patternRaster);
// this.raster = raster;
// this.borderColor = borderColor;
// this.fillColor = null;
...
// Col color = (patternRaster != null && fillColor == null) ? paint(p.getX(),
// p.getY()) : fillColor;
