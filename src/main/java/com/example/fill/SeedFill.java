...
// */
// public SeedFill(Raster<Col> raster, Col backgroundColor, Col fillColor, int
// x, int y) {
// super(null);
// this.raster = raster;
...
// * @param y Starting y-coordinate
// */
// public SeedFill(Raster<Col> raster, Raster<Col> patternRaster, Col
// backgroundColor, int x, int y) {
// super(patternRaster);
// this.raster = raster;
// this.backgroundColor = backgroundColor;
// this.fillColor = null;
