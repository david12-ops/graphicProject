...
public class Col {
	...
	public boolean equals(Object obj) {
		return (this == obj) || (obj != null) && (obj instanceof Col)
				&& (Double.valueOf(((Col) obj).getR()).equals(getR()))
				&& (Double.valueOf(((Col) obj).getG()).equals(getG()))
				&& (Double.valueOf(((Col) obj).getB()).equals(getB()))
				&& (Double.valueOf(((Col) obj).getA()).equals(getA()));
	}
