...
public class Camera {
	 ...
	 *                    camera to be copied
	 * @param firstPerson
	 *                    boolean flag indicating 1st (true) / 3rd (false) person
	 *                    camera
	 *                    mode
	 */
	 ...
	 *                    observer position
	 * @param azimuth
	 *                    angle (in radians) between the xz and uv planes where v is
	 *                    the
	 *                    view vector and u is the up vector, i.e. the vector
	 *                    considered
	 *                    vertical by observer, i.e. the vector of the y-axis of the
	 *                    camera coordinate set
	 * @param zenith
	...
	/**
	 * Returns String representation of this camera with floating point values
