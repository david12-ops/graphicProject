...
public class Quat {
	...
	/**
	 * Returns the result of right side quaternion multiplication by the given
	 * quaternion
	 *
	 * @param q
	 *          quaternion
	...
	/**
	 * Returns the result of left side quaternion multiplication by the given
	 * quaternion
	 * 
	 * @param q
	 *          quaternion
	...
	/**
	 * Creates a 4x4 transformation matrix equivalent to rotation defined by
	 * quaternion
	 * 
	...
	/**
	 * Return the angle and axis rotation in format Point3D:(angle, x-axis, y-axis,
	 * z-axis)
	 * 
	...
	/**
	 * Linear interpolation between two this and given quaternion
	 * Lerp(Q1,Q2,t)=(1-t)Q1+tQ2
	 * 
	 * @param q
	 *          quaternion
	 * @param t
	...
	public boolean equals(Object obj) {
		return (obj != null) && (obj instanceof Vec3D)
				&& (Double.valueOf(((Quat) obj).getR()).equals(getR()))
				&& (Double.valueOf(((Quat) obj).getI()).equals(getI()))
				&& (Double.valueOf(((Quat) obj).getJ()).equals(getJ()))
				&& (Double.valueOf(((Quat) obj).getK()).equals(getK()));
	}
