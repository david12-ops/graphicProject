...
public class Point3D {
	...
	/**
	 * Returns a clone of this point with the homogeneous x coordinate replaced by
	 * the
	 * given value
	 * 
	 * @param x
	...
	/**
	 * Returns a clone of this point with the homogeneous y coordinate replaced by
	 * the
	 * given value
	 * 
	 * @param y
	...
	/**
	 * Returns a clone of this point with the homogeneous z coordinate replaced by
	 * the
	 * given value
	 * 
	 * @param z
	...
	/**
	 * Returns a clone of this point with the homogeneous w coordinate replaced by
	 * the
	 * given value
	 * 
	 * @param w
	...
	public boolean equals(Object obj) {
		return (this == obj) || (obj != null) && (obj instanceof Point3D)
				&& (Double.valueOf(((Point3D) obj).getX()).equals(getX()))
				&& (Double.valueOf(((Point3D) obj).getY()).equals(getY()))
				&& (Double.valueOf(((Point3D) obj).getZ()).equals(getZ()))
				&& (Double.valueOf(((Point3D) obj).getW()).equals(getW()));
	}
	 ...
	 * @return comma separated floating-point values in parentheses, useful in
	 *         constructor
	 */
