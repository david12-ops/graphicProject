...
public class Compare {
	...
	/**
	 * Compares two double values for equivalence with the maximum relative
	 ...
	 *                E.g. with epsilon of 0.1 the difference must not exceed 10% of
	 *                either value
	...
	/**
	 * Compares two double values for equivalence with the default maximum relative
	 * difference between them.
	 *
	 * @param value1
	 *               the first double to compare
