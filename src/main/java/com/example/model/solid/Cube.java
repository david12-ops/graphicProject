...
public class Cube extends Solid {
    ...
    private void initialWireFrameMesh(double halfSize, Col[] colors) {
        // Fill in vb
        // Bottom
        vertexBuffer.add(new Vertex(new Point3D(-halfSize, -halfSize, -halfSize), colors[0]));
        vertexBuffer.add(new Vertex(new Point3D(halfSize, -halfSize, -halfSize), colors[1]));
        vertexBuffer.add(new Vertex(new Point3D(halfSize, halfSize, -halfSize), colors[2]));
